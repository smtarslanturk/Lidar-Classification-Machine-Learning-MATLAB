...
verilerEgitim = JAX_166_PC3(1:1500:end,:); 
siniflarEgitim = JAX_166_CLS(1:1500:end); 
...
indis = setdiff (1:length(JAX_166_CLS),1:1500:length(JAX_166_CLS));
indis = indis';
% Aþaðýdaki iþlemde indislerde aldýðý deðerleri gösterir.


[cPredict,score] = predict(trainedClassifier.ClassificationSVM,JAX_166_PC3(1:1:end,3:4));
