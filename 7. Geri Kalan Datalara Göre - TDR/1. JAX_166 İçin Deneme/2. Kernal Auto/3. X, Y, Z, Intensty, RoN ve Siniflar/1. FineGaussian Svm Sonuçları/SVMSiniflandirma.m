...
verilerEgitim = JAX_166_PC3(1:200:end,:); 
siniflarEgitim = JAX_166_CLS(1:200:end); 
...
indis = setdiff (1:length(JAX_166_CLS),1:200:length(JAX_166_CLS));
indis = indis';
...
% sum(siniflarEgitim==6)
% 6 sýnýf etiketnden kaç adet oldugunu gosterýr.
